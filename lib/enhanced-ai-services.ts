// Enhanced AI Services with Advanced Rate Limiting
import { GoogleGenerativeAI } from '@google/generative-ai';
import { rateLimitService } from './rate-limit-service';

// Enhanced AI Video Analysis Service
export const videoAnalysisService = {
  // Analyze video content with rate limiting
...
`;
  ...
  // Generate detailed video creation plan with rate limiting
...
// Enhanced AI Model Selection Service
